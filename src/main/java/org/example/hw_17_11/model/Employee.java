...
public class Employee {
    ...
    Наследники от главного класса будут
    ТОПы, Среднего звена, Рядовые сотрудники.
    Хранить сотрудников в папке model.
    Далее сделать класс базаДанных по аналогии с уроком.
    Хранить класс в папке bd.
    Сделать класс Сервис, который будет выполнять разного рода опреации,
    анпрмер смены должности итд. Хранить Сервисы в папке service
     */
}
